...
|---|---|---|
| `item` | `text:, href: nil, icon: nil` | Convenience alias for `with_item` to append one breadcrumb item in the block API. |
| `with_item` | `text:, href: nil, icon: nil` | Slot builder generated by `renders_many :items`; appends one item component. |
...
- `with_item(text:, href: nil, icon: nil)` provides the same slot builder explicitly.
