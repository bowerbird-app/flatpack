...
| `large_subtitle` | Boolean | `false` | no | When `true`, subtitle uses `--page-title-h1-size`, bold weight, and no top margin. |
| `title_color` | String | `nil` | no | Optional CSS color override for heading text (`h1`). |
