  ...
  module Accordion
    class Component < FlatPack::BaseComponent
      ...
      def render_item(item)
        content_tag(:div, class: "border-b border-border last:border-b-0") do
          safe_join([
      ...
      def trigger_classes
        "w-full flex items-center justify-between p-4 text-left hover:bg-muted transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset"
      end
