...
module FlatPack
  module Navbar
    class SidebarItemComponent < FlatPack::BaseComponent
      ...
      # "bg-[var(--color-primary)]" "text-[var(--color-primary-text)]" "bg-[var(--color-muted)]" "bg-[var(--color-primary)]" "text-[var(--color-primary-text)]" "bg-[var(--color-secondary)]" "text-[var(--color-secondary-text)]" "bg-[var(--color-success)]" "text-[var(--color-success-text)]" "bg-[var(--color-warning)]" "text-[var(--color-warning-text)]" "bg-[var(--color-danger)]" "text-[var(--color-danger-text)]"
      BADGE_STYLES = {
