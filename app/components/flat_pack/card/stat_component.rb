...
module FlatPack
  module Card
    class StatComponent < ViewComponent::Base
      ...
      # "text-4xl" "font-bold" "mb-2" "text-sm" "uppercase" "tracking-wide" "text-[var(--color-muted-foreground)]" "mt-2" "text-green-600" "text-red-600" "text-center"
      TREND_DIRECTIONS = {
        up: {
          icon: "↑",
      ...
      def call
        content_tag(:div, class: container_classes, **@system_arguments) do
          safe_join([
            ...
            content_tag(:div, @label, class: "text-sm text-[var(--color-muted-foreground)] uppercase tracking-wide"),
