...
module FlatPack
  module Badge
    class Component < FlatPack::BaseComponent
      ...
      # "border" "bg-[var(--badge-default-background-color)]" "text-[var(--badge-default-text-color)]" "border-[var(--badge-default-border-color)]" "bg-[var(--badge-primary-background-color)]" "text-[var(--badge-primary-text-color)]" "border-[var(--badge-primary-border-color)]" "bg-[var(--badge-success-background-color)]" "text-[var(--badge-success-text-color)]" "border-[var(--badge-success-border-color)]" "bg-[var(--badge-warning-background-color)]" "text-[var(--badge-warning-text-color)]" "border-[var(--badge-warning-border-color)]" "bg-[var(--badge-danger-background-color)]" "text-[var(--badge-danger-text-color)]" "border-[var(--badge-danger-border-color)]" "bg-[var(--badge-info-background-color)]" "text-[var(--badge-info-text-color)]" "border-[var(--badge-info-border-color)]"
      VARIANTS = {
        ...
        danger: "border bg-[var(--badge-danger-background-color)] text-[var(--badge-danger-text-color)] border-[var(--badge-danger-border-color)]",
        info: "border bg-[var(--badge-info-background-color)] text-[var(--badge-info-text-color)] border-[var(--badge-info-border-color)]"
      }.freeze

      # Tailwind CSS scanning requires these classes to be present as string literals.
      # DO NOT REMOVE - These duplicates ensure CSS generation:
      # "text-[10px]" "px-2" "py-0.5" "text-xs" "px-2.5" "py-1" "text-sm" "px-3" "text-base" "px-4" "py-2"
      SIZES = {
