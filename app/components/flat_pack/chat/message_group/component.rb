    ...
    module MessageGroup
      class Component < FlatPack::BaseComponent
        ...
        def render_default_avatar
          ...
          content_tag(:div, class: "h-8 w-8 rounded-full bg-[var(--color-muted)] flex items-center justify-center") do
            content_tag(:span, class: "text-xs font-medium text-[var(--color-muted-foreground)]") do
        ...
        def name_classes
          classes(
            "text-sm font-medium text-[var(--color-foreground)] mb-1",
