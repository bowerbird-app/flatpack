  ...
  module Comments
    module Thread
      class Component < FlatPack::BaseComponent
        ...
        # "space-y-10" "space-y-6" "rounded-[var(--radius-xl)]" "bg-[var(--surface-background-color)]"
        VARIANTS = {
          default: "space-y-10",
          compact: "space-y-6"
        }.freeze
        ...
        def render_locked_indicator
          content_tag(:div, class: "flex items-center gap-1.5 text-sm text-[var(--comments-thread-locked-color)]") do
            safe_join([
              # Lock icon
              content_tag(:svg,
