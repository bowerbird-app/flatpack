...
module FlatPack
  module CodeBlock
    class Component < FlatPack::BaseComponent
      ...
      # "bg-[var(--code-block-background-color)]" "border" "border-[var(--code-block-border-color)]" "rounded-[var(--radius-lg)]" "whitespace-pre" "whitespace-pre-wrap" "break-words" "overflow-x-auto" "font-mono" "text-sm" "text-[var(--code-block-code-color)]" "text-[var(--code-block-title-color)]"
