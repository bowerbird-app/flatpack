    ...
    module Item
      class ComponentTest < ViewComponent::TestCase
        ...
        def test_renders_active_state_with_aria_current
          render_inline(Component.new(text: "Dashboard", href: "#", active: true))
        ...
        def test_renders_collapsed_mode_accessibility
          render_inline(Component.new(text: "Settings", href: "#", collapsed: true))
        ...
        def test_renders_badge_when_provided
          render_inline(Component.new(text: "Inbox", href: "#", badge: "8"))

          assert_text "8"
        end

        def test_includes_tooltip_controller_data_attributes
          render_inline(Component.new(text: "Reports", href: "#"))
        ...
        def test_raises_for_unsafe_href
          assert_raises(ArgumentError) do
            Component.new(text: "Bad", href: "javascript:alert(1)")
          end
        end
      end
    end
