    ...
    class ComponentTest < ViewComponent::TestCase
      def test_renders_trigger_and_modal_form
        render_inline(Component.new(
          ...
          form_url: "/demo/responsive_filter",
          turbo_frame: "responsive-filter-table-frame"
        )) do |component|
        ...
        assert_selector "form#minimized-table-filters-mobile-form[data-turbo-frame='responsive-filter-table-frame']"
      ...
      def test_shows_active_count_badge_when_count_is_positive
        render_inline(Component.new(
          ...
          turbo_frame: "responsive-filter-chart-frame",
          active_count: 2
        )) do |component|
          component.filter_body do
      ...
      def test_renders_reset_and_submit_actions
        render_inline(Component.new(
          ...
          form_url: "/demo/responsive_filter",
          turbo_frame: "responsive-filter-table-frame",
          reset_url: "/demo/responsive_filter"
        )) do |component|
          component.filter_body do
