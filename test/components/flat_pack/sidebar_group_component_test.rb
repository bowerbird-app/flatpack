    ...
    module Group
      class ComponentTest < ViewComponent::TestCase
        ...
        def test_renders_with_icon
          render_inline(Component.new(title: "More", icon: :dots))
          assert_selector "button svg"
        end

        def test_renders_items_slot
          render_inline(Component.new(title: "More")) do |group|
            group.items do
              "Group items"
            end
          end
        ...
        def test_default_open_false
          render_inline(Component.new(title: "More", open: false))
          assert_selector "button[aria-expanded='false']"
        end

        def test_default_open_true
          render_inline(Component.new(title: "More", open: true))
          assert_selector "button[aria-expanded='true']"
        end

        def test_collapsed_mode_hides_label
          render_inline(Component.new(title: "More", collapsed: true))
        ...
        def test_panel_has_correct_id
          component = Component.new(title: "More")
        ...
        def test_merges_custom_classes
          render_inline(Component.new(title: "More", class: "custom-group"))
