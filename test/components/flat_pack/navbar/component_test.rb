  ...
  module Navbar
    class ComponentTest < ViewComponent::TestCase
      ...
      def test_sidebar_has_transition
        ...
        assert_includes page.native.to_html, "transition-transform"
        assert_includes page.native.to_html, "duration-[var(--duration-slow)]"
      end
      ...
      def test_sidebar_item_active_state_styling
        ...
        assert_includes html, "text-primary-text"
      end
